...
//   const recentlySwitched = useRef(false); // 🔒 block double triggers
...
//             Implement a function that returns the nth Fibonacci number. Write both recursive and iterative versions.
//           </p>
//         </div>
